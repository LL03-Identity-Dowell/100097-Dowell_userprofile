...
const MyOrganization = () => {
  return (
    <div>
            <p className="myProfile text-white fw-bold text-center">07. Your Organisation</p>

                <Form.Group className="mb-3" controlId="yourOrganization">
                    <Form.Label className='labelsStyle'>Your Organisation Name</Form.Label>
                    <Form.Control className='inputStyle' type="text" placeholder="update your organisation name" />
                </Form.Group>
                <Form.Group className="mb-3" controlId="yourOrgAddress">
                    <Form.Label className='labelsStyle'>Organisation Address</Form.Label>
                    <Form.Control className='inputStyle' as="textarea" rows={3} placeholder="Enter your organisation address" />
                </Form.Group>
                ...
                <Form.Group className="mb-3" controlId="city">
                    <Form.Label className='labelsStyle'>City of your organisation</Form.Label>
                ...
                <Form.Group className="mb-3" controlId="country">
                    <Form.Label className='labelsStyle'>Country of your organisation</Form.Label>
                ...
                <Form.Group className="mb-3" controlId="orgLogo">
                    <Form.Label className='labelsStyle'>Organisation Logo</Form.Label>
                ...
                <Form.Group className="mb-3" controlId="orgLatitude">
                    <Form.Label className='labelsStyle'>Latitude of organisation</Form.Label>
                ...
                <Form.Group className="mb-3" controlId="orgLongitude">
                    <Form.Label className='labelsStyle'>Longitude of organisation</Form.Label>
                    <Form.Control className='inputStyle' type="text" placeholder="Longitude of the geo coordinates of organisation" />
                </Form.Group>
                <Button variant="dark" className='w-100'>Update Organisation Details</Button>
