	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await fetch(
				"https://100097.pythonanywhere.com/Geographic_form",
				{
					method: "POST",
					headers: {
			...
			<Form>
				<Form.Group className="mb-3" controlId="residing">
					<Form.Label className="labelsStyle">
						Country your residing for last 5 years
					</Form.Label>
					<Form.Select
						aria-label="residing"
						className="inputStyle"
						onChange={handleOnChange}
						value={formInputs.residing}
					>
				...
				<Form.Group className="mb-3" controlId="city">
					<Form.Label className="labelsStyle">
						City your residing for last 5 years
					</Form.Label>
					<Form.Control
						className="inputStyle"
						onChange={handleOnChange}
				...
				<Form.Group className="mb-3" controlId="latitude">
					<Form.Label className="labelsStyle">
						Latitude of your house
					</Form.Label>
					<Form.Control
						className="inputStyle"
						onChange={handleOnChange}
						type="text"
						placeholder="Latitude of the geo coordinates of your house"
				...
				<Form.Group className="mb-3" controlId="longitude">
					...
					<Form.Control
						...
						onChange={handleOnChange}
						type="text"
						placeholder="Longitude of the geo coordinates of your house"
						value={formInputs.longitude}
					/>
				</Form.Group>
				<Form.Group className="mb-3" controlId="region">
					<Form.Label className="labelsStyle">
						Region inside location
					</Form.Label>
					<Form.Select
						aria-label="region"
						onChange={handleOnChange}
