			...
			<Form>
				...
				<Form.Group className="mb-3" controlId="iqlevel">
					...
					<Form.Select
						...
						className="inputStyle"
						onChange={handleOnChange}
						value={formInputs.iqlevel}
					>
						<option>
							Above 140 - <sup>""</sup>Near<sup>""</sup> genius or genius
						</option>
						<option value="verSuperior">
				...
				<Form.Group className="mb-3" controlId="personality">
					<Form.Label className="labelsStyle">
						Your Personality (test using https://www.16personalities.com/)
					</Form.Label>
					<Form.Select
						aria-label="personality"
						className="inputStyle"
						onChange={handleOnChange}
						value={formInputs.personality}
					>
