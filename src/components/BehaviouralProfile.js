	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await fetch(
				"https://100097.pythonanywhere.com/Behaviour_form",
				{
					method: "POST",
					headers: {
			...
			if (response.ok) {
				...
				const updatedUser = {
					...
					behavioural: {
						benefits: formInputs.benefits,
						role: formInputs.buying,
						brand_loyalty: formInputs.brand,
						others_behaviour: formInputs.others,
					},
				};
			...
			<Form>
				<Form.Group className="mb-3" controlId="benefits">
					<Form.Label className="labelsStyle">
						Benefits you are looking while buying any product or service
					</Form.Label>
					<Form.Select
						aria-label="benefits"
						className="inputStyle"
						onChange={handleOnChange}
						value={formInputs.benefits}
					>
				...
				<Form.Group className="mb-3" controlId="buying">
					<Form.Label className="labelsStyle">
						Your role while buying any product or service
					</Form.Label>
					<Form.Select
						aria-label="buying"
						className="inputStyle"
						onChange={handleOnChange}
						value={formInputs.buying}
					>
				...
				<Form.Group className="mb-3" controlId="brand">
					<Form.Label className="labelsStyle">
						Brand loyalty level you will consider while buying any product or
						service
					</Form.Label>
					<Form.Select
						aria-label="brand"
